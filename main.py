...
def get_font(size=10, bold=False):
    ...
    # Try common modern fonts, fallback to sans-serif
    return ("Inter", "Segoe UI", "Helvetica", "Arial", "sans-serif"), size, weight
...
class AnalysisWindow(tk.Toplevel):
    ...
    def __init__(self, parent, results):
        ...
        tk.Label(bar, text="MAGIKA ANALYSIS", font=get_font(22, True),
                 bg=self.BG, fg="white").pack(side="left")
        tk.Button(bar, text="EXPORT JSON", font=get_font(10, True),
        ...
        for val, lbl in [(str(total), "Total Files"),
            ...
            tk.Label(card, text=val, font=get_font(20, True),
                     bg=self.BG_CARD, fg="white").pack()
            tk.Label(card, text=lbl, font=get_font(9),
        ...
        tk.Label(right, text="FILE INSPECTOR", font=get_font(14, True),
        ...
        tk.Entry(tb, textvariable=self._search_var,
                 font=get_font(10), bg="#333", fg="white",
                 insertbackground="white", relief="flat", width=22).pack(side="left", padx=6)

        tk.Label(tb, text="Type:", font=get_font(9),
        ...
        cb = ttk.Combobox(tb, textvariable=self._type_var,
                          ...
                          state="readonly", width=14, font=get_font(9))
        cb.pack(side="left", padx=2)
        cb.bind("<<ComboboxSelected>>", self._apply_filters)

        tk.Button(tb, text="Reset", font=get_font(8),
